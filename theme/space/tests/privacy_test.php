...
use \theme_space\privacy\provider;

/**
 * Unit tests for theme_space/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_space_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_space');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_space'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_space'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
