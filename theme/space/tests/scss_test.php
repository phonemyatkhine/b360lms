...
/**
 * This file contains the unittests for space's scss compilation.
 *
 * @package   theme_space
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_space_scss_testcase extends advanced_testcase {
    /**
     * Test that space can be compiled using SassC (the defacto implemention).
     */
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('space')->get_css_content_debug('scss', null, null)
        );
    }
}
