...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_coursebox(coursecat_helper $chelper, $course, $additionalclasses = '') {
		...
		$content .= "<div class='c-course-content row no-gutters'>";
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $content .= html_writer::start_tag('div', array('class' => 'c-course-box-content'));
		...
		$content .= "<div class='course-box-desc'>";
    ...
    protected function get_course_summary_image($course, $courselink) {
        ...
        foreach ($course->get_course_overviewfiles() as $file) {
           ...
           if ($isimage) {
	           	$content .= "<a href='$courselink' class='col-12 align-self-start p-0'>";
	            $content .= "<div class='card-img-top myoverviewimg courseimage' style='background-image: url($url);'></div>";
	            $content .= "</a>";
            }
        ...
        if (empty($content)) {
            $url = $CFG->wwwroot . "/theme/space/pix/default_course.jpg";
           	...
           	$content .= "<a href='$courselink' class='col-12 align-self-start'>";
            $content .= "<div class='card-img-top myoverviewimg courseimage' style='background-image: url($url);'></div>";
            $content .= "</a>";
